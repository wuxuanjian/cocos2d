...
bool WelComeGameLayer::setUpdateView(){
	...
	do
	{
		...
		// 创建升级系统菜单
		CCTexture2D* textureup_up = CCTextureCache::sharedTextureCache()->textureForKey("upup.png");
		CCTexture2D* textureup_down = CCTextureCache::sharedTextureCache()->textureForKey("updwon.png");
		...
		// 创建退出游戏菜单
		CCTexture2D* textureout_up = CCTextureCache::sharedTextureCache()->textureForKey("outup.png");
		CCTexture2D* textureout_down = CCTextureCache::sharedTextureCache()->textureForKey("outdown.png");
