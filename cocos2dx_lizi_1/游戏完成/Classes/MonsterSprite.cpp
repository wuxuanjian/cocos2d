...
bool MonsterSprite::setUpdateView(){
	...
	{
		// 添加血条的背景图片
		CCSprite* bloodbackimg=CCSprite::createWithTexture(CCTextureCache::sharedTextureCache()->textureForKey("monster_blood_frame.png"));
		...
		// 添加进度条
		CCSprite* blood=CCSprite::createWithTexture(CCTextureCache::sharedTextureCache()->textureForKey("monster_blood.png"));
		CC_BREAK_IF(!blood);
