...
bool AboutCoderLayer::setUpdateView(){
	...
	{
        // 添加背景图片
        CCTexture2D* textture=CCTextureCache::sharedTextureCache()->textureForKey("coder.png");
        ...
        // 创建返回菜单
        CCTexture2D* texturestar_up = CCTextureCache::sharedTextureCache()->textureForKey("return_up.png");
        CCTexture2D* texturestar_down = CCTextureCache::sharedTextureCache()->textureForKey("return_down.png");
